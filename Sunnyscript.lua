...
function DiscordLib:Window(text,mainclr,cls)
	local PresetColor = mainclr or Color3.fromRGB(255,50,0) or _G.Color
...
elseif lv == 475 or lv <= 524 then
	...
	NameQ = "SkyExp1Quest"
	NumberQ = 2
	PosMon = CFrame.new(-7863.63672, 5545.49316, -379.826324, 0.362120807, -1.98046344e-08, -0.93213129, 4.05822291e-08, 1, -5.48095125e-09, 0.93213129, -3.58431969e-08, 0.362120807)
	PosQ = CFrame.new(-7685.12354, 5601.05127, -443.171509, 0.150056243, 1.79768236e-08, -0.988677442, 6.67798661e-09, 1, 1.91962481e-08, 0.988677442, -9.48289181e-09, 0.150056243)
elseif lv == 525 or lv <= 549 then
	Mon = "Royal Squad [Lv. 525]"
	NameQ = "SkyExp2Quest"
	NumberQ = 1
	PosMon = CFrame.new(-7902.66895, 5635.96387, -1411.71802, 0.0504222959, 2.5710392e-08, 0.998727977, 1.12541557e-07, 1, -3.14249675e-08, -0.998727977, 1.13982921e-07, 0.0504222959)
	PosQ = CFrame.new(-7685.02051, 5606.87842, -1442.729, 0.561947823, 7.69527464e-09, -0.827172697, -4.24974544e-09, 1, 6.41599973e-09, 0.827172697, -9.01838604e-11, 0.561947823)
elseif MyLevel == 550 or MyLevel <= 624 then -- Royal Soldier
	Mon = "Royal Soldier [Lv. 550]"
	NameQ = "SkyExp2Quest"
	NumberQ = 2
	PosMon = CFrame.new(-7902.66895, 5635.96387, -1411.71802, 0.0504222959, 2.5710392e-08, 0.998727977, 1.12541557e-07, 1, -3.14249675e-08, -0.998727977, 1.13982921e-07, 0.0504222959)
	PosQ = CFrame.new(-7864.44775, 5661.94092, -1708.22351, 0.998389959, 2.28686137e-09, -0.0567218624, 1.99431383e-09, 1, 7.54200258e-08, 0.0567218624, -7.54117195e-08, 0.998389959)
elseif MyLevel == 625 or MyLevel <= 649 then -- Galley Pirate
	Mon = "Galley Pirate [Lv. 625]"
	NameQ = "FountainQuest"
	NumberQ = 1
	PosMon = CFrame.new(5254.60156, 38.5011406, 4049.69678, -0.0504891425, -3.62066501e-08, -0.998724639, -9.87921389e-09, 1, -3.57534553e-08, 0.998724639, 8.06145284e-09, -0.0504891425)
	PosQ = CFrame.new(5595.06982, 41.5013695, 3961.47095, -0.992138803, -2.11610267e-08, -0.125142589, -1.34249509e-08, 1, -6.26613996e-08, 0.125142589, -6.04887518e-08, -0.992138803)
elseif MyLevel >= 650 then -- Galley Captain
	Mon = "Galley Captain [Lv. 650]"
	NameQ = "FountainQuest"
	NumberQ = 2
	PosMon = CFrame.new(5254.60156, 38.5011406, 4049.69678, -0.0504891425, -3.62066501e-08, -0.998724639, -9.87921389e-09, 1, -3.57534553e-08, 0.998724639, 8.06145284e-09, -0.0504891425)
	PosQ = CFrame.new(5658.5752, 38.5361786, 4928.93506, -0.996873081, 2.12391046e-06, -0.0790185928, 2.16989656e-06, 1, -4.96097414e-07, 0.0790185928, -6.66008248e-07, -0.996873081)
end
end
...
AutoFarm:Toggle("FastAttack", false, function(value)
_G.FastAttack = value
end)
...
AutoFarm:Dropdown("select weapon", Weaponlist, function(currentOption)
    Weapon = currentOption
end)

AutoFarm:Toggle("Auto Equip", " ", function(a)
AutoEquiped = a
end)
...
function Redeem()
game:GetService("ReplicatedStorage").Remotes.Redeem:InvokeServer("Tantaigaming","Enyu_is_Pro","Sub2Fer999","Magicbus","JCWK","Starcodeheo","Bluxxy","SUB2GAMERROBOT_EXP1","Sub2NoobMaster123","Sub2Daigrock","Axiore","StrawHatMaine","Sub2OfficialNoobie","TheGreatAce")
end
Misc:Button("RedeemCode X2", function(a)
	Redeem()
end)
